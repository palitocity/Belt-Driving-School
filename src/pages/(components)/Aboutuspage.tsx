    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      ...
      <section className="bg-blue-700 text-white py-16 text-center">
        ...
        <p className="text-lg max-w-2xl mx-auto">
          Building confident, skilled, and responsible drivers through
          excellence in education and modern training.
        </p>
      </section>
      ...
      <section className="py-16 px-6 md:px-20 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg">
          At Belt Driving School, our mission is to provide top-quality driving
          education that ensures every student becomes a safe, confident, and
          responsible driver. We believe that driving is not just a skill, but a
          lifelong responsibility that requires discipline and awareness.
        </p>
      </section>
      ...
      <section className="py-16 px-6 md:px-20 bg-white">
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-gray-100 rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition duration-300"
            >
              <Image
                src={member.image}
                alt={member.name}
      ...
      <section className="py-16 px-6 md:px-20 bg-blue-700 text-white text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg">
          To become the leading driving institution in Nigeria, shaping the
          future of road safety and creating a new generation of disciplined
          drivers.
        </p>
      </section>
    </div>
